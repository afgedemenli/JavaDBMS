...
public class RecordType implements Comparable<RecordType> {
	 ...
	 * Constructor.
	 */
	public RecordType(String typeName, Integer numberOfFields) {
	...
	public String toString() {
		return typeName + " " + numberOfFields + " ";
	}
	...
	public int compareTo(RecordType recordType) {
		String compare = recordType.getTypeName();
		return this.typeName.compareTo(compare);
	}
}
