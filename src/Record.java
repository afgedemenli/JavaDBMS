...
public class Record implements Comparable<Record> {
	...
	/**
	 * Properties of a record as described in the report.
	 */
	...
	public String toString() {
		String fieldsString = "";
		for (Integer field : this.fields) {
			fieldsString = fieldsString + field + " ";
		}
		return recordHeader.toString() + fieldsString;
	}
	...
	public int compareTo(Record record) {
		return this.fields.get(0) - record.getFields().get(0);
	}
}
